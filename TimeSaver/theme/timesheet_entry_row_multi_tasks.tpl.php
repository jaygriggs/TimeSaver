...
<tr id="row<?php print $rownumber; ?>" class="<?php print $evenodd?>"  title="<?php print $rejected_note?>">
    ...
    <td style="display:none"><input type="text" size="2"  name="isSecondaryRow<?php print $rownumber; ?>"  id="isSecondaryRow<?php print $rownumber; ?>" value="1"></td>
    <td></td>
    <td class="entryRowLeftCell" style="<?php print $rejected_style; ?>"><input type="checkbox" <?php print $disable_on_lock; ?> name="chk<?php print $rownumber; ?>" id="chk<?php print $rownumber; ?>"></td>
    ...
    <td class="entryRowMiddleCell" style="<?php print $rejected_style; ?>" id="projectTD<?php print $rownumber; ?>" onchange="changeflag()">
...
<option value="' . $mivalue . '"';
					...
					if (isset($regMinSelect) && strcmp($regMinSelect,$mivalue) == 0) {
                         echo ' selected="selected"';
                    }
                    echo ">" . $mikey . "</option>\n";
                }
...
?>
		   ...
		   <input type="hidden" <?php print $disable_on_lock; ?> style="<?php print $rejected_style; ?>" size="2"  name="regMilitary<?php print $rownumber; ?>" value="<?php $regMilitary; ?>"></td>
...
<option value="' . $mivalue . '"';
				   ...
				   if (isset($statMinSelect) && strcmp($statMinSelect,$mivalue) == 0) {
                         echo ' selected="selected"';
                    }
...
<option value="' . $xvalue . '"';
				   ...
				   if (isset($vacationHourSelect) && strcmp($vacationHourSelect,$xvalue) == 0) {
                         echo ' selected="selected"';
                    }
...
<option value="' . $mivalue . '"';
					...
					if (isset($vacationMinSelect) && strcmp($vacationMinSelect,$mivalue) == 0) {
                         echo ' selected="selected"';
                    }
                    echo ">" . $mikey . "</option>\n";
                }
...
<option value="' . $xvalue . '"';
                   if (isset($_POST['sickHourSelect' . $i]) && $_POST['sickHourSelect' . $i] == $xvalue) {
				    ...
				    if (isset($sickHourSelect) && strcmp($sickHourSelect,$xvalue) == 0) {
                         echo ' selected="selected"';
                    }
...
<option value="' . $mivalue . '"';
					...
					if (isset($sickMinSelect) && strcmp($sickMinSelect,$mivalue) == 0) {
                         echo ' selected="selected"';
                    }
                    echo ">" . $mikey . "</option>\n";
                }
...
?>"></td>
    ...
    <td class="entryRowMiddleCell" style="<?php print $rejected_style; ?>;display:<?php print $display_for_approval; ?>"><input type="checkbox"  name="chkapproval<?php print $rownumber; ?>" id="chkapproval<?php print $rownumber; ?>" value="1" <?php print $chkapproval_checked; ?> <?php print $disable_if_approved; ?> onclick="doApprovalPageApprove('chkapproval<?php print $rownumber; ?>','chkreject<?php print $rownumber; ?>','<?php print $rownumber; ?>','<?php print $id; ?>');"></td>
    ...
    <td class="entryRowMiddleCell" style="<?php print $rejected_style; ?>;display:<?php print $display_for_entry_rejection; ?>"><input type="button"  id="btnCheckReject<?php print $rownumber; ?>" value="Reason" onclick="showReason('<?php print $id; ?>')"><input type="button" id="btnClearReject<?php print $rownumber; ?>" value="Clear" onclick="clearReject('<?php print $id; ?>','<?php print $uid; ?>')" style="font-size:7pt"></td>
</tr>
